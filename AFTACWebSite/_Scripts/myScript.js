...
$(document).ready(function () {
    ...
    $('#myVoice').click(function () {
        $('.myArts').removeClass('block').addClass('noDisplay');
        $('#VoiceArt').removeClass('noDisplay').addClass('block');
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#VoiceTitle").offset().top
        }, 500);
    });

    $('#myLetters').click(function () {
        window.open('_PDFs/Letter Auction.pdf', '');
    });

    $('#myReunion').click(function () {
        $('.myArts').removeClass('block').addClass('noDisplay');
        $('#myReunionArt').removeClass('noDisplay').addClass('block');
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#reunionPara").offset().top
        }, 500);
    });
    ...
    $('#myFun').click(function () {
        ...
        window.open('https://www.youtube.com/watch?v=-YFRUSTiFUs', '');
    //    $('.myArts').removeClass('block').addClass('noDisplay');
    ...
    $('#butCancel').mouseover(function () {
        $('#butCancel').css('background-color', 'red');
        $('#butCancel span').css('background-color', 'red').css('color', 'yellow');
    });

    $('#butCancel').mouseout(function () {
        $('#butCancel').css('background-color', 'yellow');
        $('#butCancel span').css('background-color', 'yellow').css('color', 'black');
    });

    $('#butCancel').click(function () {
        $('.myArts').removeClass('block').addClass('noDisplay');
        $('#CancelArt').removeClass('noDisplay').addClass('block');
    });
    ...
    $('#myBobowicz').click(function () {
        OpenObit('Bobowicz');
    });

    $('#myEAnderson').click(function () {
        OpenObit('EAnderson');
    });

    $('#myStern').click(function () {
        OpenObit('Stern');
    });
    ...
    $('.obitH1').click(function () {
        ...
        switch (myText) {
            case 'SternH2':
                if ($('#SternPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#SternPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#SternH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#SternPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#SternH2").offset().top
                    }, 500);
                }
                break;
            case 'EAndersonH2':
                if ($('#EAndersonPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#EAndersonPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#EAndersonH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#EAndersonPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#EAndersonH2").offset().top
                    }, 500);
                }
                break;
            case 'BobowiczH2':
                if ($('#BobowiczPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#BobowiczPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#BobowiczH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#BobowiczPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#BobowiczH2").offset().top
                    }, 500);
                }
                break;
            case 'MinamotoH2':
                if ($('#MinamotoPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#MinamotoPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#MinamotoH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#MinamotoPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#MinamotoH2").offset().top
                    }, 500);
                }
                break;
            case 'WagleyH2':
                if ($('#WagleyPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#WagleyPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#WagleyH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#WagleyPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#WagleyH2").offset().top
                    }, 500);
                }
                break;
            case 'PerkinsH2':
                if ($('#PerkinsPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#PerkinsPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#PerkinsH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#PerkinsPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#PerkinsH2").offset().top
                    }, 500);
                }
                break;
            case 'JohnsonH2':
                if ($('#JohnsonPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#JohnsonPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#JohnsonH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#JohnsonPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#JohnsonH2").offset().top
                    }, 500);
                }
                break;
            case 'BorowskiH2':
                if ($('#BorowskiPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#BorowskiPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#BorowskiH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#BorowskiPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#BorowskiH2").offset().top
                    }, 500);
                }
                break;
            case 'LepusH2':
                if ($('#LepusPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#LepusPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#LepusH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#LepusPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#LepusH2").offset().top
                    }, 500);
                }
                break;
            case 'CreeryH2':
                if ($('#CreeryPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#CreeryPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#CreeryH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#CreeryPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#CreeryH2").offset().top
                    }, 500);
                }
                break;
            case 'BertlemannH2':
                if ($('#BertlemannPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#BertlemannPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#BertlemannH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#BertlemannPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#BertlemannH2").offset().top
                    }, 500);
                }
                break;
            case 'RiceH2':
                if ($('#RicePara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#RicePara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#RiceH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#RicePara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#RiceH2").offset().top
                    }, 500);
                }
                break;
            case 'SchmiedH2':
                if ($('#SchmiedPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#SchmiedPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#SchmiedH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#SchmiedPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#SchmiedH2").offset().top
                    }, 500);
                }
                break;
                if ($('#OsbornePara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#OsbornePara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#OsborneH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#OsbornePara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#OsborneH2").offset().top
                    }, 500);
                }
                break;
            case 'EllingsonH2':
                if ($('#EllingsonPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#EllingsonPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#EllingsonH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#EllingsonPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#EllingsonH2").offset().top
                    }, 500);
                }
                break;
            case 'MoxleyH2':
                if ($('#MoxleyPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#MoxleyPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#MoxleyH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#MoxleyPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#MoxleyH2").offset().top
                    }, 500);
                }
                break;
            case 'DanielsH2':
                if ($('#DanielsPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#DanielsPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#DanielsH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#DanielsPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#DanielsH2").offset().top
                    }, 500);
                }
                break;
            case 'AndersonH2':
                if ($('#AndersonPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#AndersonPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#AndersonH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#AndersonPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#AndersonH2").offset().top
                    }, 500);
                }
                break;
            case 'StevensH2':
                if ($('#StevensPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#StevensPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#StevensH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#StevensPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#StevensH2").offset().top
                    }, 500);
                }
                break;
            case 'HumphreyH2':
                if ($('#HumphreyPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#HumphreyPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#HumphreyH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#HumphreyPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#HumphreyH2").offset().top
                    }, 500);
                }
                break;
            case 'MarshallH2':
                if ($('#MarshallPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#MarshallPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#MarshallAH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#MarshallPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#MarshallH2").offset().top
                    }, 500);
                }
                break;
            case 'ReynoldsAH2':
                if ($('#ReynoldsAPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#ReynoldsAPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#ReynoldsAH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#ReynoldsAPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#ReynoldsAH2").offset().top
                    }, 500);
                }
                break;
            case 'ReynoldsH2':
                if ($('#ReynoldsPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#ReynoldsPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#ReynoldsH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#ReynoldsPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#ReynoldsH2").offset().top
                    }, 500);
                }
                break;
            case 'KretzschmarH2':
                if ($('#KretzschmarPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#KretzschmarPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#KretzschmarH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#KretzschmarPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#KretzschmarH2").offset().top
                    }, 500);
                }
                break;
            case 'JamesH2':
                if ($('#JamesPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#JamesPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#JamesH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#JamesPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#JamesH2").offset().top
                    }, 500);
                }
                break;
            case 'PaisleyH2':
                if ($('#PaisleyPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#PaisleyPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#PaisleyH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#PaisleyPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#PaisleyH2").offset().top
                    }, 500);
                }
                break;
            case 'HumphriesH2':
                if ($('#HumphriesPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#HumphriesPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#HumphriesH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#HumphriesPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#HumphriesH2").offset().top
                    }, 500);
                }
                break;
            case 'WoodardH2':
                if ($('#WoodardPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#WoodardPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#WoodardH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#WoodardPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#WoodardH2").offset().top
                    }, 500);
                }
                break;
            case 'SerdynskiH2':
                if ($('#SerdynskiPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#SerdynskiPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#SerdynskiH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#SerdynskiPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#SerdynskiH2").offset().top
                    }, 500);
                }
                break;
            case 'LongH2':
                if ($('#LongPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#LongPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#LongH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#LongPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#LongH2").offset().top
                    }, 500);
                }
                break;
            case 'CastilloH2':
                if ($('#CastilloPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#CastilloPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#CastilloH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#CastilloPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#CastilloH2").offset().top
                    }, 500);
                }
                break;
            case 'HarrisH2':
                if ($('#HarrisPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#HarrisPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#HarrisH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#HarrisPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#HarrisH2").offset().top
                    }, 500);
                }
                break;
            case 'LovanH2':
                if ($('#LovanPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#LovanPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#LovanH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#LovanPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#LovanH2").offset().top
                    }, 500);
                }
                break;
            case 'KubiakH2':
                if ($('#KubiakPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#KubiakPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#KubiakH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#KubiakPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#KubiakH2").offset().top
                    }, 500);
                }
                break;
            case 'SmithDH2':
                if ($('#SmithDPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#SmithDPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#SmithDH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#SmithDPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#SmithDH2").offset().top
                    }, 500);
                }
                break;
            case 'StephanH2':
                if ($('#StephanPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#StephanPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#StephanH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#StephanPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#StephanH2").offset().top
                    }, 500);
                }
                break;
            case 'VillarealH2':
                if ($('#VillarealPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#VillarealPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#VillarealH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#VillarealPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#VillarealH2").offset().top
                    }, 500);
                }
                break;
            case 'ChadwickH2':
                if ($('#ChadwickPara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#ChadwickPara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#ChadwickH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#ChadwickPara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#ChadwickH2").offset().top
                    }, 500);
                }
                break;
            case 'GentileH2':
                if ($('#GentilePara').is(':hidden')) {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#GentilePara').removeClass('noDisplay').addClass('block');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#GentileH2").offset().top
                    }, 500);
                }
                else {
                    $('.obitPara').removeClass('block').addClass('noDisplay');
                    $('#GentilePara').removeClass('block').addClass('noDisplay');
                    $([document.documentElement, document.body]).animate({
                        scrollTop: $("#GentileH2").offset().top
                    }, 500);
                }
    ...
    $('#aprilPomo').click(function () {
        window.open('https://aftacaa.us/_Pomos/PoMo2021_04.pdf', '');
    });

    $('#augustPomo').click(function () {
        window.open('https://aftacaa.us/_Pomos/PoMo2020_08.pdf', '');
    });

    $('#decemberPomo').click(function () {
        window.open('https://aftacaa.us/_Pomos/PoMo2020_12.pdf', '');
    });
    ...
    $('#meetingMinutes').click(function () {
        window.open('_Minutes/6-14-2021_Minutes.pdf', '');
    });
    ...
    $('#vid_2018AirShow').click(function () {
        window.open('https://www.youtube.com/embed/276_lTJkgWU', '');
    });
